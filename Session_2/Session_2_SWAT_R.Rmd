...
par_fast <- fast_parameters(minimum = c(-15,   1, 0.1,-50, -50, 0,  0),
                              maximum = c( 10, 100,  18, 50,  50, 1, 25), 
                              names = par_names)

```

To perform a FAST analysis for 7 parameters 167 model evaluations are required. We run the SWAT model with the parameter set sampled with `fast` and evaluate the simulations.
